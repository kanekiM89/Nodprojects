        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ url('dashboard') }}" class="navbar-brand mx-4 mb-3">
                    <h4 class="text-primary"><i class="fa fa-hashtag me-2"></i>YOUR PROJECT</h4>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('u.index') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>User</a>
                    <a href="{{ route('c.index') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Category</a>
                    <a href="{{ route('p.index') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Product</a>
